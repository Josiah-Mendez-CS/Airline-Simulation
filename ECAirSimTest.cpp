...
static void Test1()
{
    ...
    std::vector<double> expectedPrices;
    expectedPrices.push_back(432);
    expectedPrices.push_back(0);
    expectedPrices.push_back(0);
    expectedPrices.push_back(288);
    expectedPrices.push_back(0);
    expectedPrices.push_back(432);
    expectedPrices.push_back(0);
    expectedPrices.push_back(432);
    expectedPrices.push_back(0);
    expectedPrices.push_back(792);

    std::vector<int> expectedNumSegments;
    expectedNumSegments.push_back(1);
    expectedNumSegments.push_back(0);
    expectedNumSegments.push_back(0);
    expectedNumSegments.push_back(1);
    expectedNumSegments.push_back(0);
    expectedNumSegments.push_back(1);
    ...
    expectedNumSegments.push_back(1);
    expectedNumSegments.push_back(0);
    expectedNumSegments.push_back(2);

    std::vector<double> expectedFlightTime;
    expectedFlightTime.push_back(3.6);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(2.4);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(3.6);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(3.6);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(6.6);
...
static void Test2()
{
    ...
    std::vector<double> expectedPrices;
    expectedPrices.push_back(864);
    expectedPrices.push_back(72);
    expectedPrices.push_back(0);
    expectedPrices.push_back(720);
    expectedPrices.push_back(360);
    expectedPrices.push_back(864);
    expectedPrices.push_back(0);
    expectedPrices.push_back(696);
    ...
    std::vector<double> expectedFlightTime;
    expectedFlightTime.push_back(7.2);
    expectedFlightTime.push_back(0.6);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(6);
    expectedFlightTime.push_back(3);
    expectedFlightTime.push_back(7.2);
    expectedFlightTime.push_back(0);
    expectedFlightTime.push_back(5.8);
